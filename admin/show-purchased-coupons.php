...
$query = "SELECT coupons.id,startDate,endDate,couponName,totalCoupons,SUM(`boughtQty`) AS boughtCoupons ,coupons_sold.status,couponPrice,`couponId`FROM coupons INNER JOIN coupons_sold ON 
