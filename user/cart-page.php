										...
										<div class="row">
											...
											<div class="col-md-7">
												<div class="col-md-12">
													...
													<h4>NEED HELP ?</h4> <a href="#">Contact us</a> </div>
												<div class="col-md-12" style="margin-top:35%">
													<h4>ACCEPTED PAYMENT METHODS</h4> <img width=180px src="images/we-accept.jpg"> </div>
											</div>
													...
													<form class="row" method="post" data-bvalidator-validate action="razorpay/pay.php">
														...
														<div class="form-group col-md-12">
															...
															<div class="form-group col-md-12">
																...
																<input class="form-control" type="text" id="qty" name="qty" data-bvalidator="required" min="1" max="10"> </div>
															<div class="form-group col-md-12">
